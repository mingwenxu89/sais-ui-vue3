...
export enum DICT_TYPE {
  ...
  // ========== AGRI 农业模块 ==========
  AGRI_CROP_TYPE = 'agri_crop_type', // 作物类型
  AGRI_CROP_STATUS = 'agri_crop_status', // 作物状态
  AGRI_FIELD_STATUS = 'agri_field_status', // 地块状态
  AGRI_DEVICE_TYPE = 'agri_device_type', // IoT设备类型
  AGRI_DEVICE_STATUS = 'agri_device_status', // IoT设备状态
  AGRI_IRRIGATION_TRIGGER = 'agri_irrigation_trigger', // 灌溉触发方式
  AGRI_IRRIGATION_STATUS = 'agri_irrigation_status', // 灌溉状态
  AGRI_ALERT_TYPE = 'agri_alert_type', // 告警类型
  AGRI_ALERT_LEVEL = 'agri_alert_level', // 告警级别
  AGRI_ALERT_STATUS = 'agri_alert_status', // 告警状态
  ...
  AGRI_DROUGHT_RESISTANCE_LEVEL = 'agri_drought_resistance_level', // 抗旱级别
  AGRI_WATERLOGGING_TOLERANCE_LEVEL = 'agri_waterlogging_tolerance_level', // 耐涝级别
  AGRI_GROW_STATUS = 'agri_grow_status', // 种植状态
  AGRI_SENSOR_TYPE = 'agri_sensor_type', // 传感器类型
  AGRI_SENSOR_STATUS = 'agri_sensor_status', // 传感器状态
  AGRI_IRRIGATION_DEVICE_STATUS = 'agri_irrigation_device_status' // 灌溉设备状态
}
