<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column label="Email" align="center" prop="mail" />
      <el-table-column label="Username" align="center" prop="username" />
      <el-table-column label="SMTP Host" align="center" prop="host" />
      <el-table-column label="Port" align="center" prop="port" />
      <el-table-column label="SSL" align="center" prop="sslEnable">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.INFRA_BOOLEAN_STRING" :value="scope.row.sslEnable" />
        </template>
      </el-table-column>
      <el-table-column label="STARTTLS" align="center" prop="starttlsEnable">
        <template #default="scope">
