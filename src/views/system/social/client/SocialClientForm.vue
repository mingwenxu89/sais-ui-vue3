  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="Client ID" prop="clientId">
        <el-input v-model="formData.clientId" placeholder="Enter client ID,对应各平台的appKey" />
      </el-form-item>
      <el-form-item label="Client Secret" prop="clientSecret">
        <el-input
          v-model="formData.clientSecret"
          placeholder="Enter client secret (appSecret)"
        />
      </el-form-item>
      ...
      <el-form-item label="publicKey" prop="publicKey" v-if="formData!.socialType === 40">
        <el-input v-model="formData.publicKey" placeholder="Enter publicKey 公钥" />
      </el-form-item>
