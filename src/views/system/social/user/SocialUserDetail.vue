<template>
  <Dialog v-model="dialogVisible" title="Detail" width="800">
    <el-descriptions :column="1" border>
      <el-descriptions-item label="Social Platform" min-width="160">
        <dict-tag :type="DICT_TYPE.SYSTEM_SOCIAL_TYPE" :value="detailData.type" />
      </el-descriptions-item>
      <el-descriptions-item label="Nickname" min-width="120">
        {{ detailData.nickname }}
      </el-descriptions-item>
      ...
      <el-descriptions-item label="Raw Token Data" min-width="120">
        <el-input
      ...
      <el-descriptions-item label="Raw User Data" min-width="120">
        <el-input
      ...
      <el-descriptions-item label="Last Auth Code" min-width="120">
        {{ detailData.code }}
      </el-descriptions-item>
      <el-descriptions-item label="Last Auth State" min-width="120">
        {{ detailData.state }}
      </el-descriptions-item>
    </el-descriptions>
  </Dialog>
