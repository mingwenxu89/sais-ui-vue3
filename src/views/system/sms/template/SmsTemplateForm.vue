<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    <el-form
      ...
      label-width="140px"
    >
      <el-form-item label="SMS Channel ID" prop="channelId">
        <el-select v-model="formData.channelId" placeholder="Select短信渠道编号">
          <el-option
      ...
      <el-form-item label="短信类型" prop="type">
        <el-select v-model="formData.type" placeholder="Select短信类型">
          <el-option
      ...
      <el-form-item label="Template ID" prop="code">
        <el-input v-model="formData.code" placeholder="Enter模板编号" />
      </el-form-item>
      ...
      <el-form-item label="Template Content" prop="content">
        <el-input v-model="formData.content" placeholder="Enter template content" type="textarea" />
      </el-form-item>
      ...
      <el-form-item label="SMS API Template ID" prop="apiTemplateId">
        <el-input v-model="formData.apiTemplateId" placeholder="Enter SMS API template ID" />
      </el-form-item>
