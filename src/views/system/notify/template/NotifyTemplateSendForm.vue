<template>
  <Dialog v-model="dialogVisible" title="Test Send" :max-height="500">
    <el-form
      ref="formRef"
    ...
    >
      ...
      <el-form-item v-show="formData.userType === 1" label="Recipient ID" prop="userId">
        <el-input v-model="formData.userId" style="width: 160px" />
      </el-form-item>
      <el-form-item v-show="formData.userType === 2" label="Recipient" prop="userId">
        <el-select v-model="formData.userId" placeholder="Select recipient">
          <el-option
