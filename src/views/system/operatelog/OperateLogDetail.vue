<template>
  <Dialog v-model="dialogVisible" :max-height="500" :scroll="true" title="Detail" width="800">
    <el-descriptions :column="1" border>
      ...
      <el-descriptions-item label="Trace ID" v-if="detailData.traceId">
        {{ detailData.traceId }}
      </el-descriptions-item>
      ...
      <el-descriptions-item label="Sub Type">
        {{ detailData.subType }}
      </el-descriptions-item>
      <el-descriptions-item label="Action">
        {{ detailData.action }}
      </el-descriptions-item>
      <el-descriptions-item v-if="detailData.extra" label="Extra Params">
        {{ detailData.extra }}
      </el-descriptions-item>
      ...
      <el-descriptions-item label="Biz ID">
        {{ detailData.bizId }}
      </el-descriptions-item>
    </el-descriptions>
  </Dialog>
...
const detailData = ref({} as OperateLogApi.OperateLogVO) // Detail数据
