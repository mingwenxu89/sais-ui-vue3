<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="User" align="center" prop="userName" width="120" />
      <el-table-column label="Type" align="center" prop="type" width="120" />
      <el-table-column label="Sub Type" align="center" prop="subType" width="160" />
      ...
      />
      <el-table-column label="Biz ID" align="center" prop="bizId" width="120" />
      <el-table-column label="IP" align="center" prop="userIp" width="120" />
      <el-table-column label="Actions" align="center" fixed="right" width="60">
