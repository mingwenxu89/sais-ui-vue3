<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="IP Address" align="center" prop="userIp" width="180" />
      <el-table-column label="User Agent" align="center" prop="userAgent" />
      <el-table-column label="Result" align="center" prop="result">
        <template #default="scope">
